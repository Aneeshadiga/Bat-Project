...
class BME:
    ...
    def getBMEData(self): 
        ...
        if humidity > 100.0 :
            ...
            humidity = 0.0# Output data to main
        return list([cTemp, fTemp, pressure, humidity])

    def putBMEData(self, data):
        print("Temperature in Celsius : {:.2f} C".format(data[0]))
        print("Temperature in Fahrenheit : {:.2f} F".format(data[1]))
        print("Pressure : {:.2f} hPa ".format(data[2]))
        print("Relative Humidity : {:.2f} %%".format(data[3]))
